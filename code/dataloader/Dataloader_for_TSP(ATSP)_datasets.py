...
"""## 报错
处理矩阵太大时候，计算错误 \brd14051.tsp.gz


```

  File "C:\Users\myPC\Downloads\最终大作业（总结tsp问题算法）(1).py", line 733, in <module>
    TSP_DATA(i)

  File "C:\Users\myPC\Downloads\最终大作业（总结tsp问题算法）(1).py", line 118, in deco
    res = func(*args, **kwargs)

  File "C:\Users\myPC\Downloads\最终大作业（总结tsp问题算法）(1).py", line 176, in __init__
    self.cal_table_and_matrix()

  File "C:\Users\myPC\Downloads\最终大作业（总结tsp问题算法）(1).py", line 194, in cal_table_and_matrix
    self.table = self.coordinate_2_table()

  File "C:\Users\myPC\Downloads\最终大作业（总结tsp问题算法）(1).py", line 632, in coordinate_2_table
